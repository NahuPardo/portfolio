          ...
          <figure className=" bg-gradient-to-b from-slate-200 via-slate-300 to-slate-200 rounded-xl p-10  my-5">
              ...
              <div class="pt-6 md:p-8 text-center md:text-left space-y-4">
                <figcaption class="font-medium">
                  ...
                  <div className=''>
                    <a href='./NahuelPardoCV.pdf' download={cv} className="bg-gradient-to-r from-sky-600 to-sky-800 hover:from-sky-600 hover:to-sky-700  rounded-md text-white p-2">Descargar CV</a>
                  </div>
              </div>
          </figure>
      </div>
